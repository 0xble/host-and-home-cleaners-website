...
export default function PrivacyPolicy() {
  return (
    <div className='prose mx-auto my-32 max-w-2xl prose-headings:font-serif prose-strong:font-serif'>
      <h1 className='text-center'>
        {NAME} <br /> Privacy Policy
      </h1>
      <p>Here&apos;s how we protect your data and respect your privacy.</p>
      <h2>Our Role in Your Privacy</h2>
      <p>
        If you are a {NAME} customer or subscriber, or just visiting our
        website, this policy applies to you.
      </p>
      <h2>Our Responsibilities</h2>
      <p>
        If you are a registered {NAME} customer or a visitor to our website, we
      ...
      <p>
        From the moment you request a quote from {NAME}, we start collecting
      ...
      <ul>
        <li>
          Data is not collected when a customer requests a quote from {NAME}.
        </li>
        <li>Data is not collected when {NAME} calls the customer.</li>
      </ul>
      <h3>When Data is Collected by {NAME}:</h3>
      <ul>
        <li>
          Data may be collected when the customer uses {NAME}&apos;s services.
        </li>
        <li>
          Data may be collected when the customer receives emails from {NAME}.
        </li>
        <li>
          Data may be collected when the customer engages in a chat with {NAME}
      ...
      <p>
        ...
        {NAME} at children, and we do not knowingly collect any personal data
      ...
      <p>
        ...
        consent at any time. You can do this by emailing us at {EMAIL}. If you
      ...
      <ul>
        ...
        <li>Delivering, developing, and improving the {NAME} service.</li>
        <li>
      ...
      <p>
        ...
        from marketing by emailing us at {EMAIL}
      </p>
      ...
      <ul>
        <li>
          <strong>Not Providing Data:</strong> You can choose not to provide us
          with personal data. If you choose to do so, you can continue to use
          the website and browse its pages, but we will not be able to process
          transactions without personal data.
        </li>
        <li>
          <strong>Turning Off Cookies:</strong> You can turn off cookies in your
        ...
        <li>
          <strong>Opting Out of Marketing:</strong> You can ask us not to use
        ...
        <li>
          <strong>Accessing Your Information:</strong> You have the right to
        ...
        <li>
          <strong>Correcting Data:</strong> You have the right to make us
          correct any inaccurate personal data about you.
        </li>
        <li>
          <strong>Objecting to Data Use:</strong> You can object to us using
          your data for profiling or making automated decisions about you.
        </li>
        <li>
          <strong>Porting Data:</strong> You have the right to port your data to
          another service. We will provide your data in a commonly used format.
        </li>
        <li>
          <strong>Being Forgotten:</strong> You have the right to be
          &quot;forgotten&quot; by us. You can do this by asking us to erase any
          personal data we hold about you.
        </li>
        <li>
          <strong>Lodging Complaints:</strong> You have the right to lodge a
          complaint regarding our use of your data. Please contact us at {EMAIL}{' '}
      ...
      <p>
        <strong>How secure is the data we collect?</strong> We have physical,
      ...
      <p>
        <strong>Where do we store the data?</strong> The personal data we
      ...
      <p>
        <strong>How long do we store your data?</strong> We archive and stop
        actively using any personally identifiable information about you within
        3 months from the last time you used {NAME}. We delete your personal
        data from our archives no later than 6 years from the last time you used{' '}
        {NAME} or as agreed in a separate contract.
      </p>
      ...
      <p>
        ...
        measurement anonymously. When you interact with {NAME} as a user, we
        (and third parties) will issue cookies unless you adjust your browser
        settings to refuse them.
      </p>

      <p>
        <strong>Blocking Cookies:</strong> You can block cookies by activating a

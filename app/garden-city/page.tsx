...
export default async function GardenCity() {
  return (
    <Page className='mb-24 flex min-h-screen flex-col gap-12 lg:mb-32 lg:gap-12'>
      ...
      <section className='bg-white pt-8 dark:bg-gray-900 lg:pt-12'>
        <div className='mx-auto grid max-w-screen-xl gap-0 px-4 py-8 lg:grid-cols-12 lg:py-16'>
          ...
          <div className='lg:col-span-6 lg:mt-0 lg:flex'>
            <FeaturedCarousel folder='myrtle-beach' />
          </div>
        </div>
      </section>
                  ...
                  answer: (
                    <>
                      <p className='mb-6'>
                        ...
                        {NAME} stands out with exceptional quality and
                        commitment.
                      </p>

...
import { ServiceCategory, Frequency } from "@/lib/types"
...
export default function BookingFormNavbar({
  ...
  return (
    <>
      {/* Progress bar */}
      <div className="fixed bottom-20 left-0 right-0 z-10 bg-white">
        <Progress
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 bg-white shadow-md h-20">
        <div className="w-full flex items-center justify-between px-6 py-4 h-full">

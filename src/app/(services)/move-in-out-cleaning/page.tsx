...
export default function MoveCleaning() {
  return (
    <Page location='CACHED' className='mx-4 pb-24'>
      ...
      <section className='prose mx-auto mb-24 max-w-screen-md'>
        ...
        <ul>
          <li>
            ...
            {' '}
            A comprehensive deep clean of the kitchen,
          ...
          <li>
            ...
            {' '}
            Meticulous cleaning of bathrooms to
          ...
          <li>
            ...
            {' '}
            Thorough dusting, vacuuming, and
        ...
        <ul>
          <li>
            <strong>Reputation and Reviews:</strong>
            {' '}
          ...
          <li>
            <strong>Cost and Transparency:</strong>
            {' '}
      ...
      <Suspense>
        <CTASection
          heading='Prepare for a Spotless Home!'
          body='Book your move-in/move-out cleaning service with us today and take the first step towards a cleaner, healthier home. Experience the difference of a truly spotless environment. Make a commitment to a cleaner, healthier living space and see the remarkable results of our expert move-in/move-out cleaning services.'
          location='CACHED'
        />
      </Suspense>
    </Page>

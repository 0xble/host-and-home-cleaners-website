...
export const metadata: Metadata = {
  title: `Professional House & Vacation Rental Cleaners in Makiki | ${BUSINESS_NAME}`,
  description: `${TAGLINE}. Serving Makiki\'s residential and vacation rental properties. 5-star rated cleaners with outstanding testimonials. Book today!`,
  openGraph: {
    title: `Professional House & Vacation Rental Cleaners in Makiki | ${BUSINESS_NAME}`,
    description: `${TAGLINE}. Serving Makiki\'s residential and vacation rental properties. 5-star rated cleaners with outstanding testimonials. Book today!`,
    url: `${getBaseUrl()}/makiki`,
    type: 'website',
    images: [
      {
...
export default function Makiki() {
  return (
    <LocationLandingPage
      location="HONOLULU"
      ...
      copy={{
        ...
        heroDescription: 'Professional cleaning services tailored for Makiki\'s homes and vacation rentals. We deliver exceptional quality that keeps your property pristine and welcoming.',
        reviewsHeading: 'Client Experiences',
        locationsSectionHeading: 'Serving All of Makiki',
        locationsSectionDescription: 'Providing premium cleaning services throughout Makiki, from Wilder Avenue to Nehoa Street!',
        ...
        pricingDescription: (
          <>
            <p className="mb-4 text-left">
              Experience cleaning services designed for Makiki\'s properties! We understand the unique needs of both residential homes and vacation rentals. Our comprehensive services address everything from regular maintenance to deep cleaning needs.
            </p>
        ...
        faqs: [
          {
            question: 'What makes your service ideal for Makiki properties?',
            answer: (
              <>
                <p className="mb-6">
                  As cleaning specialists in Makiki, our team at
                  {' '}
          ...
          },
          {
            ...
            answer: (
              <p>
                We understand plans can change. We request 24 hours\' notice for rescheduling to help us maintain efficient service for all our Makiki clients.
              </p>
            ),
          },
          {
        ...
        ctaHeading: 'Book Your Clean Now',
        ctaBody: (
          <>
            Get your
            {' '}
            ...
            {' '}
            approaching, our schedule fills quickly. Book now through our 24/7 online system and experience why Makiki residents trust us with their homes!
          </>
        ),
      }}
    />

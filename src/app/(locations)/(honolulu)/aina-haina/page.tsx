  ...
  return (
    <LocationLandingPage
      ...
      copy={{
        ...
        heroDescription: 'Professional cleaning services tailored for Aina Haina\'s homes and vacation rentals. We deliver exceptional quality that keeps your property pristine and welcoming.',
        reviewsHeading: 'Client Experiences',
        locationsSectionHeading: 'Serving All of Aina Haina',
        locationsSectionDescription: 'Providing premium cleaning services throughout Aina Haina, from East Hind Drive to Wailupe Valley!',

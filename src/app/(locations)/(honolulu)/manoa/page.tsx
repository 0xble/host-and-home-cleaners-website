  ...
  return (
    <>
      <ContentViewTracker
        ...
        contentName='Manoa'
        contentId='manoa-location'
      />
      <ServiceSchemaMarkup
        neighborhoodName='Manoa'
        fullServiceName='Professional House Cleaning Services in Manoa'
        description={`${TAGLINE}. Professional house cleaning services in Manoa, Honolulu area.`}
        url={`https://${URL}/manoa`}

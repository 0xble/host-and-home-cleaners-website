  ...
  return (
    <>
      <ContentViewTracker
        ...
        contentName='Moanalua'
        contentId='moanalua-location'
      />
      <ServiceSchemaMarkup
        neighborhoodName='Moanalua'
        fullServiceName='Professional House Cleaning Services in Moanalua'
        description={`${TAGLINE}. Professional house cleaning services in Moanalua, Honolulu area.`}
        url={`https://${URL}/moanalua`}

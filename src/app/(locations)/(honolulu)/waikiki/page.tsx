  ...
  return (
    <>
      <ContentViewTracker
        ...
        contentName='Waikiki'
        contentId='waikiki-location'
      />
      <ServiceSchemaMarkup
        neighborhoodName='Waikiki'
        fullServiceName='Professional House Cleaning Services in Waikiki'
        description={`${TAGLINE}. Professional house cleaning services in Waikiki, Honolulu area.`}
        url={`https://${URL}/waikiki`}

  ...
  return (
    <>
      <ContentViewTracker
        ...
        contentName='Kakaako'
        contentId='kakaako-location'
      />
      <ServiceSchemaMarkup
        neighborhoodName='Kakaako'
        fullServiceName='Professional House Cleaning Services in Kakaako'
        description={`${TAGLINE}. Professional house cleaning services in Kakaako, Honolulu area.`}
        url={`https://${URL}/kakaako`}

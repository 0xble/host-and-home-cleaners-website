  ...
  return (
    <>
      <ContentViewTracker
        ...
        contentName='Palolo'
        contentId='palolo-location'
      />
      <ServiceSchemaMarkup
        neighborhoodName='Palolo'
        fullServiceName='Professional House Cleaning Services in Palolo'
        description={`${TAGLINE}. Professional house cleaning services in Palolo, Honolulu area.`}
        url={`https://${URL}/palolo`}

...
export const metadata: Metadata = {
  title: `Professional House & Airbnb Cleaners in East York | ${BUSINESS_NAME}`,
  description: `${TAGLINE}. Proudly serving East York and the greater York area. Professional 5-star cleaners with dozens of testimonials. Book today!`,
  openGraph: {
    title: `Professional House & Airbnb Cleaners in East York | ${BUSINESS_NAME}`,
    description: `${TAGLINE}. Proudly serving East York and the greater York area. Professional 5-star cleaners with dozens of testimonials. Book today!`,
    url: `${getBaseUrl()}/york/east-york`,
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${BUSINESS_NAME} in East York, PA`,
      },
    ],
  },
  twitter: {
  ...
  return (
    <LocationLandingPage
      ...
      copy={{
        heroHeading: (
          <>
            Expert Home Cleaning Services in East York, PA
          </>
        ),
        heroDescription: 'Professional residential cleaning services tailored for East York homes and vacation rentals. We deliver exceptional quality that keeps your property pristine and welcoming.',
        reviewsHeading: 'Client Experiences',
        locationsSectionHeading: 'Serving All of East York',
        locationsSectionDescription: 'Providing premium cleaning services throughout East York and the surrounding York County area!',
        ...
        pricingDescription: (
          <>
            <p className="mb-4 text-left">
              Experience cleaning services designed for East York's properties! We understand the unique needs of both residential homes and vacation rentals in the York County area. Our comprehensive services address everything from regular maintenance to deep cleaning needs.
            </p>
        ...
        faqs: [
          {
            question: 'What makes your service ideal for East York properties?',
            answer: (
              <>
                <p className="mb-6">
                  As cleaning specialists serving East York and the greater York area, our team at
                  {' '}
          ...
          },
          {
            ...
            answer: (
              <p>
                We understand plans can change. We request 24 hours' notice for rescheduling to help us maintain efficient service for all our East York and York area clients.
              </p>
            ),
          },
          {
        ...
        ctaBody: (
          <>
            ...
            . With busy schedules filling up quickly, our schedule fills fast. Book now through our 24/7 online system and experience why East York residents trust us with their homes!
          </>
        ),
      }}
    />

...
export const metadata: Metadata = {
  title: `Professional House & Airbnb Cleaners in Spring Grove | ${BUSINESS_NAME}`,
  description: `${TAGLINE}. Proudly serving Spring Grove and the greater York area. Professional 5-star cleaners with dozens of testimonials. Book today!`,
  openGraph: {
    title: `Professional House & Airbnb Cleaners in Spring Grove | ${BUSINESS_NAME}`,
    description: `${TAGLINE}. Proudly serving Spring Grove and the greater York area. Professional 5-star cleaners with dozens of testimonials. Book today!`,
    url: `${getBaseUrl()}/york/spring-grove`,
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${BUSINESS_NAME} in Spring Grove, PA`,
      },
    ],
  },
  twitter: {
...
export default function SpringGrove() {
  return (
    <LocationLandingPage
      location="YORK"
      // TODO: Remove this once we have reviews for York/Spring Grove
      reviewsLocationOverride={null}
      googleMapsEmbedUrl={LOCATIONS.YORK.googleMapsEmbedUrl}
      // TODO: Upload more photos and replace with York/Spring Grove photos
      ...
      copy={{
        heroHeading: (
          <>
            Expert Home Cleaning Services in Spring Grove, PA
          </>
        ),
        heroDescription: 'Professional residential cleaning services tailored for Spring Grove homes and vacation rentals. We deliver exceptional quality that keeps your property pristine and welcoming.',
        reviewsHeading: 'Client Experiences',
        locationsSectionHeading: 'Serving All of Spring Grove',
        locationsSectionDescription: 'Providing premium cleaning services throughout Spring Grove and the surrounding York County area!',
        ...
        pricingDescription: (
          <>
            <p className="mb-4 text-left">
              Experience cleaning services designed for Spring Grove's properties! We understand the unique needs of both residential homes and vacation rentals in the York County area. Our comprehensive services address everything from regular maintenance to deep cleaning needs.
            </p>
        ...
        faqs: [
          {
            question: 'What makes your service ideal for Spring Grove properties?',
            answer: (
              <>
                <p className="mb-6">
                  As cleaning specialists serving Spring Grove and the greater York area, our team at
                  {' '}
          ...
          },
          {
            ...
            answer: (
              <p>
                We understand plans can change. We request 24 hours' notice for rescheduling to help us maintain efficient service for all our Spring Grove and York area clients.
              </p>
            ),
          },
          {
        ...
        ctaBody: (
          <>
            ...
            . With busy schedules filling up quickly, our schedule fills fast. Book now through our 24/7 online system and experience why Spring Grove residents trust us with their homes!
          </>
        ),
      }}
    />

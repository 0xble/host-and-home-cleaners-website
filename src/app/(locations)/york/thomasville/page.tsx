...
export const metadata: Metadata = {
  title: `Professional House & Airbnb Cleaners in Thomasville | ${BUSINESS_NAME}`,
  description: `${TAGLINE}. Proudly serving Thomasville and the greater York area. Professional 5-star cleaners with dozens of testimonials. Book today!`,
  openGraph: {
    title: `Professional House & Airbnb Cleaners in Thomasville | ${BUSINESS_NAME}`,
    description: `${TAGLINE}. Proudly serving Thomasville and the greater York area. Professional 5-star cleaners with dozens of testimonials. Book today!`,
    url: `${getBaseUrl()}/york/thomasville`,
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${BUSINESS_NAME} in Thomasville, PA`,
      },
    ],
  },
  twitter: {
...
export default function Thomasville() {
  return (
    <LocationLandingPage
      location="YORK"
      // TODO: Remove this once we have reviews for York/Thomasville
      reviewsLocationOverride={null}
      googleMapsEmbedUrl={LOCATIONS.YORK.googleMapsEmbedUrl}
      // TODO: Upload more photos and replace with York/Thomasville photos
      ...
      copy={{
        heroHeading: (
          <>
            Expert Home Cleaning Services in Thomasville, PA
          </>
        ),
        heroDescription: 'Professional residential cleaning services tailored for Thomasville homes and vacation rentals. We deliver exceptional quality that keeps your property pristine and welcoming.',
        reviewsHeading: 'Client Experiences',
        locationsSectionHeading: 'Serving All of Thomasville',
        locationsSectionDescription: 'Providing premium cleaning services throughout Thomasville and the surrounding York County area!',
        ...
        pricingDescription: (
          <>
            <p className="mb-4 text-left">
              Experience cleaning services designed for Thomasville's properties! We understand the unique needs of both residential homes and vacation rentals in the York County area. Our comprehensive services address everything from regular maintenance to deep cleaning needs.
            </p>
        ...
        faqs: [
          {
            question: 'What makes your service ideal for Thomasville properties?',
            answer: (
              <>
                <p className="mb-6">
                  As cleaning specialists serving Thomasville and the greater York area, our team at
                  {' '}
          ...
          },
          {
            ...
            answer: (
              <p>
                We understand plans can change. We request 24 hours' notice for rescheduling to help us maintain efficient service for all our Thomasville and York area clients.
              </p>
            ),
          },
          {
        ...
        ctaBody: (
          <>
            ...
            . With busy schedules filling up quickly, our schedule fills fast. Book now through our 24/7 online system and experience why Thomasville residents trust us with their homes!
          </>
        ),
      }}
    />

    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${BUSINESS_NAME} in Garden City`,
      },
    ],
  },
  twitter: {
  ...
  return (
    <LocationLandingPage
      ...
      copy={{
        ...
        heroDescription: 'Professional residential cleaning services with quick turnaround times and competitive rates — trusted by Garden City homeowners, vacation rental hosts, and real estate professionals!',
        reviewsHeading: 'What Are Others Saying?',
        locationsSectionHeading: 'We\'re Close By!',
        locationsSectionDescription: 'Proudly serving all areas of Garden City and the surrounding communities!',

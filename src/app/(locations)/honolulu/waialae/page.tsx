...
export const metadata: Metadata = {
  title: `Professional House & Vacation Rental Cleaners in Waialae | ${BUSINESS_NAME}`,
  description: `${TAGLINE}. Serving Waialae\'s residential and vacation rental properties. 5-star rated cleaners with outstanding testimonials. Book today!`,
  openGraph: {
    title: `Professional House & Vacation Rental Cleaners in Waialae | ${BUSINESS_NAME}`,
    description: `${TAGLINE}. Serving Waialae\'s residential and vacation rental properties. 5-star rated cleaners with outstanding testimonials. Book today!`,
    url: `${getBaseUrl()}/waialae`,
    type: 'website',
    images: [
      {
  ...
  return (
    <LocationLandingPage
      ...
      copy={{
        ...
        heroDescription: 'Professional cleaning services tailored for Waialae\'s homes and vacation rentals. We deliver exceptional quality that keeps your property pristine and welcoming.',
        reviewsHeading: 'Client Experiences',
        locationsSectionHeading: 'Serving All of Waialae',
        locationsSectionDescription: 'Providing premium cleaning services throughout Waialae, from Waialae Avenue to Kahala Avenue!',
        ...
        faqs: [
          ...
          },
          {
            ...
            answer: (
              <p>
                We understand plans can change. We request 24 hours' notice for rescheduling to help us maintain efficient service for all our Waialae clients.
              </p>
            ),
          },
          {
        ...
        ctaHeading: 'Schedule Your Clean',
        ctaBody: (
          <>
            Get your
            {' '}
            ...
            {' '}
            approaching, our schedule fills quickly. Book now through our 24/7 online system and experience why Waialae residents trust us with their homes!
          </>
        ),
      }}
    />

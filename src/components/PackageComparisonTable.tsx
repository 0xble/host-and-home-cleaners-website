  ...
  return (
    <div id='detailed-pricing' className={cn('w-full overflow-x-auto')}>
      <div className='overflow-hidden'>
        <div className='grid grid-cols-7 items-center justify-center gap-x-6 border-b border-gray-200 p-4 font-medium text-gray-900 sm:gap-x-16'>
        ...
        {inclusions.map(({ name, services }) => (
          <div
            key={name}
            className='grid grid-cols-7 items-center justify-center gap-x-6 border-b border-gray-200 p-4 text-xs text-gray-900 sm:gap-x-16'
          >

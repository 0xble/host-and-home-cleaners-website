...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300',
  {
    variants: {
      variant: {
        default:
          'border-transparent bg-shade text-zinc-50 hover:bg-shade/80 dark:bg-zinc-50 dark:text-shade dark:hover:bg-zinc-50/80',
        secondary:
          'border-transparent bg-primary-100 text-primary-800 hover:bg-zinc-100/80 dark:bg-zinc-800 dark:text-zinc-50 dark:hover:bg-zinc-800/80',
        destructive:

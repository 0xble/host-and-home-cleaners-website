  ...
  return (
    <div id='detailed-pricing' className={cn('w-full overflow-x-auto')}>
      <div className='overflow-hidden'>
        <div className='grid grid-cols-3 items-center justify-center gap-x-16 border-b border-gray-200 p-4 text-xs font-medium text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-white md:text-sm'>
        ...
        {comparisonCriteria.map(
          ({ criteria, isOfferedByUs, isOfferedByCompetitors }) => (
            <div
              key={criteria}
              className='grid grid-cols-3 items-center justify-center gap-x-16 border-b border-gray-200 p-4 text-xs text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-white md:text-sm'
            >
